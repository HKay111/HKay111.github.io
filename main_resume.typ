...
[],
[Implemented a Salant (1976)/Hotelling (1931) resource-extraction model with a cartel and competitive fringe, then extended it to T periods with a corner-correct complementarity fringe.
Carbon-tax experiments reproduce the green-paradox channel: a rising tax path increases early extraction.])
